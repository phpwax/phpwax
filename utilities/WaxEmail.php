...
class WaxEmail
{
    ...
    function MailSend($header, $body)
    {
        ...
        // Whilst we may have multiple To: headers the PHP Mail function needs a single To address passed in
    ...
    function AttachAll()
    {
        ...
        // Add all attachments
        foreach ($this->attachment as $i => $iValue) {
    ...
    {
        $result = false;
        foreach ($this->attachment as $iValue) {
            if ($iValue[6] === "inline") {
                $result = true;
                break;
            }
