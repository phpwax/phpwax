...
class WaxModelAssociation extends WaxRecordset {
  ...
  public function __construct(WaxModel $model, WaxModel $target_model, $rowset, $owner_field) {
    $this->rowset = $rowset;
    $this->model = $model;
  ...
  public function offsetGet($offset) {
    if(is_numeric($this->rowset[$offset])) return $this->current_object;
    else{
