...
class ExampleOwner extends Model {
...
class ExampleEditor extends Model {
  public function setup() {
    $this->define("name", "CharField", array("maxlength"=>40));
    $this->define("examples", "HasManyField", array("target_model"=>"Example"));
  }
...
class ExampleProperty extends Model {
  public function setup() {
    $this->define("name", "CharField", array("maxlength"=>40));
...
class ExampleOneWayProperty extends Model {
  public function setup(){
    $this->define("name","CharField");
  }
}

class WaxModelTest extends WaxTestCase {
    public function setup() {
    ...
    public function tearDown() {
      Model::$db->drop_table($this->model->table);
			Model::$db->drop_table($this->prop->table);
